...
class DADataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        dataset_train = DADataset(data_path = self.hparams.data_dir_s,num_classes=self.hparams.num_classes,domain_label = 0,image_path=self.hparams.image_path)
        dataset_val = DADataset(data_path = self.hparams.data_dir_v,num_classes=self.hparams.num_classes,domain_label = 1,image_path=self.hparams.image_path)
        dataset_test = DADataset(data_path = self.hparams.data_dir_t,num_classes=self.hparams.num_classes,domain_label = 1,image_path=self.hparams.image_path)
