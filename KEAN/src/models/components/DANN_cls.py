...
class DANN(nn.Module):
    def __init__(
        ...
        self.encoder_content = Content_Encoder(input_size=1024,output_size=256)
        ...
        self.classifer = news_classifier(input_size=306,hidden_size=hidden_size,hidden_size_2=hidden_size_2,num_class=num_classes)
